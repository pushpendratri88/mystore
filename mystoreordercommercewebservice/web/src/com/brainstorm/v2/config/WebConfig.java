 ...
 */
package com.brainstorm.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import com.brainstorm.constants.YcommercewebservicesConstants;
import com.brainstorm.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "mystoreordercommercewebservice.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "mystoreordercommercewebservice.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "mystoreordercommercewebservice.oauth2.tokenUrl";

	private static final String DESC = "mystoreordercommercewebservice.v2.description";
	private static final String TITLE = "mystoreordercommercewebservice.v2.title";
	private static final String VERSION = "mystoreordercommercewebservice.v2.version";
	private static final String LICENSE = "mystoreordercommercewebservice.v2.license";
	private static final String LICENSE_URL = "mystoreordercommercewebservice.v2.license.url";
	...
	private static final String LEGACY_CONTENT_NEGOTIATION = "mystoreordercommercewebservice.content.negotiation.legacy";
