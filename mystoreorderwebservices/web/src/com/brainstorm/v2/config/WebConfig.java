...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "mystoreorderwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "mystoreorderwebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "mystoreorderwebservices.oauth2.tokenUrl";

	private static final String DESC = "mystoreorderwebservices.v2.description";
	private static final String TITLE = "mystoreorderwebservices.v2.title";
	private static final String VERSION = "mystoreorderwebservices.v2.version";
	private static final String LICENSE = "mystoreorderwebservices.v2.license";
	private static final String LICENSE_URL = "mystoreorderwebservices.v2.license.url";
	...
	private static final String LEGACY_CONTENT_NEGOTIATION = "mystoreorderwebservices.content.negotiation.legacy";
